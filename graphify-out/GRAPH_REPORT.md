# Graph Report - wavelength-demo  (2026-07-17)

## Corpus Check
- 85 files · ~49,647 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 373 nodes · 466 edges · 63 communities (55 shown, 8 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `f5a846e4`
...
8. `pr-status.sh script` - 7 edges
9. `parseFrontmatter()` - 7 edges
10. `toLayer()` - 7 edges

## Surprising Connections (you probably didn't know these)
- `WaveFormProps` --references--> `Phase`  [EXTRACTED]
  src/components/WaveForm.tsx → src/data/modes.ts
- `useWaveReveal()` --calls--> `computeWaveState()`  [EXTRACTED]
  src/components/useWaveReveal.tsx → src/lib/scroll.ts
- `ReferencePage()` --calls--> `useWaveReveal()`  [EXTRACTED]
  src/pages/ReferencePage.tsx → src/components/useWaveReveal.tsx
...
Cohesion: 0.17
Nodes (18): Frontmatter, indexByFirstCell(), isSeparator(), leadText(), parseFrontmatter(), parseTable(), splitRow(), DOC (+10 more)

### Community 1 - "Community 1"
Cohesion: 0.07
Nodes (29): eslint, eslint-plugin-react, eslint-plugin-react-hooks, eslint-plugin-react-refresh, prettier, @types/react, @types/react-dom, typescript (+21 more)

### Community 2 - "Community 2"
Cohesion: 0.07
Nodes (27): react, react-dom, serve, dependencies, react, react-dom, serve, description (+19 more)
...
Cohesion: 0.21
Nodes (14): MobileAppCta(), Lines(), renderToken(), RichText(), InlineToken, tokenizeInline(), hexToRgb(), luminance() (+6 more)

### Community 5 - "Community 5"
Cohesion: 0.12
Nodes (25): useWaveReveal(), ARROWS, WaveForm(), WaveFormProps, CANONICAL, FIELD, Mode, MODES (+17 more)
...
Cohesion: 0.39
Nodes (5): RevealPanel, WaveReveal, clamp01(), computeWaveState(), WaveState
...
## Knowledge Gaps
- **168 isolated node(s):** `name`, `private`, `version`, `type`, `description` (+163 more)
